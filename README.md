# Plasma_Flame_Radio
  ...
  This personal project was my first big step into RF circuits and pushed me to buy an oscilloscope and a vector network analyzer (VNA).  


## Part 1: Plasma Flame  
<img src=".\Media\massive_flame.gif" height="200"  />  

This circuit pumps enough power into the antenna to rip apart air and create a "plasma flame". controlling the power of the flame with audio can turn it into a speaker! listen to the "singing flame" on my [linkedin_post](https://www.linkedin.com/posts/levi-sawatzky_pcbdesign-innovation-tech-activity-7251831981049618432-Eb7l?utm_source=share&utm_medium=member_desktop)
